...
const brand_controller_js_1 = require("./brand.controller.js");
...
exports.BrandModule = BrandModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [brand_controller_js_1.BrandController],
        providers: [brand_service_js_1.BrandService],
        exports: [brand_service_js_1.BrandService],
    })
], BrandModule);
