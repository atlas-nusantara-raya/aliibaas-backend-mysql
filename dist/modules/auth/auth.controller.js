...
let AuthController = class AuthController {
    ...
    async register(registerDto) {
        return this.authService.register(registerDto.email, registerDto.password, registerDto.name, registerDto.phone);
    }
...
exports.AuthController = AuthController = __decorate([
    ...
    (0, throttler_1.Throttle)({ auth: { limit: 20, ttl: 60000 } }),
