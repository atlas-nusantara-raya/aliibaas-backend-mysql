...
const size_controller_js_1 = require("./size.controller.js");
let SizeModule = class SizeModule {
};
exports.SizeModule = SizeModule;
exports.SizeModule = SizeModule = __decorate([
    (0, common_1.Module)({
        controllers: [size_controller_js_1.SizeController],
        providers: [size_service_js_1.SizeService],
        exports: [size_service_js_1.SizeService],
    })
], SizeModule);
