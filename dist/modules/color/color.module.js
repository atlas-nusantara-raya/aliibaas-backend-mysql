...
const color_controller_js_1 = require("./color.controller.js");
let ColorModule = class ColorModule {
};
exports.ColorModule = ColorModule;
exports.ColorModule = ColorModule = __decorate([
    (0, common_1.Module)({
        controllers: [color_controller_js_1.ColorController],
        providers: [color_service_js_1.ColorService],
        exports: [color_service_js_1.ColorService],
    })
], ColorModule);
